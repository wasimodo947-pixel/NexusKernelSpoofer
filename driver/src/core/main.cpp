...
HOOK_INFO* g_AllHooks[] = { &g_DiskHook, &g_VolHook, &g_RegHook, &g_MacHook, &g_SmbiosHook, &g_GpuHook, &g_AntiReadHook, &g_ModuleHideHook, NULL };

// DeviceIoControl, DriverUnload, DriverEntry completos con hypervisor
